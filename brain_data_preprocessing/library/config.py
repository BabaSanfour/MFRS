...
if user == 'hamza97':
    study_path = '/home/hamza97/scratch/data/MFRS_data/reproducible_data/'
    N_JOBS = 1
else:
...
tmin = -0.2
tmax = 2.9  # min duration between onsets: (400 fix + 800 stim + 1700 ISI) ms # Inter-stimulus intervals

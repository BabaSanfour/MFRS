...
def VGGFace(pretrained: bool = False, num_classes: int =1000):
    ...
    vggface_model=tf.keras.models.Model(inputs=vggface_model.layers[0].input, outputs=vggface_model.layers[-1].output)
